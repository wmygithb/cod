...
public class BaseDao {
    ...
    //需要生成mapper文件的sql语句
    private static String sql = "select sn.*,bu.cname,case sn.type when 1 then 'note' when 2 then 'question' end as typedesc,bc.class_name \n" +
            "from student_note sn join base_user bu on sn.user_id = bu.user_id\n" +
            "\t\t     join base_class bc on bu.class_id = bc.class_id\n" +
            "\t\torder by sn.note_id desc";
    //主表
    private static String mainTable = "student_note";
...
//                    插入association配置
    ...
    public   static  Connection getConn(){
        ...
        String url = "jdbc:mysql://172.25.20.107:3306/code?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=UTC&zeroDateTimeBehavior=convertToNull";
